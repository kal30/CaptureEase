...
const InviteCarePartnerPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error sending care partner invitation:', error);
      ...
      >
        ...
        <Box sx={{ 
          ...
          <Typography variant="h6" color="text.secondary">
            Add a family member or close friend to your team
          </Typography>
        </Box>
        ...
        <CardContent sx={{ p: 4 }}>
          ...
          <Box sx={{ 
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Care partners can view all progress and add entries
              </Typography>
            </Box>
          </Box>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              fullWidth
              label="Care Partner Email Address"
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              required
              sx={{ mb: 3 }}
              helperText="The care partner will receive an invitation email"
            />
            ...
            <TextField
              ...
              placeholder="Hi! I'd like to invite you to join our care team for [child's name]. As a care partner, you'll be able to help track progress and stay connected..."
            />
            ...
            <Box sx={{ 
              ...
              <Box sx={{ pl: 2 }}>
                ...
                <Typography variant="body2" sx={{ mb: 1 }}>
                  • Add daily activities and mood tracking
                </Typography>
                <Typography variant="body2" sx={{ mb: 1 }}>
...
export default InviteCarePartnerPage;