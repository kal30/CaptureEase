...
export const LOG_TYPES = {
  sleep: {
    ...
    trackLabel: 'Sleep',
    icon: '😴',
    palette: createPalette('#EFF2FF', '#3949AB', '#4C1D95'),
    trackChip: true,
    trackOrder: 2,
  ...
  food: {
    ...
    trackLabel: 'Food',
    icon: '🍽️',
    palette: createPalette('#FFF8F1', '#7C5A3A', '#2563EB'),
    trackChip: true,
    trackOrder: 3,
    filterGroup: 'entryType',
  },
  medication: {
    ...
    trackLabel: 'Meds',
    icon: '💊',
    palette: createPalette('#F5FAF1', '#355534', '#D97706'),
    trackChip: true,
    trackOrder: 1,
    filterGroup: 'entryType',
  },
  bathroom: {
    ...
    trackLabel: 'Toilet',
    icon: '🚽',
    palette: createPalette('#F0FFFB', '#267F6E', '#64748B'),
    trackChip: true,
    trackOrder: 4,
    filterGroup: 'entryType',
  },
  activity: {
    ...
    trackLabel: 'Activity',
    icon: '🕐',
    palette: createPalette('#F0FAFE', '#345B6C', '#F43F5E'),
    trackChip: true,
    trackOrder: 5,
    filterGroup: 'entryType',
  },
  ...
  behavior: {
    ...
    trackLabel: 'Behavior',
    icon: '🌪️',
    palette: createPalette('#F5F3FF', '#4C3D78', '#B45309'),
    trackChip: true,
    trackOrder: 6,
    filterGroup: 'flagged',
  },
