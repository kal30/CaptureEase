...
// Components
import MobileDashboardFlow from "./mobile/MobileDashboardFlow";
import DesktopDashboardWorkspace from "./desktop/DesktopDashboardWorkspace";
...
import PatternSuggestionModal from "./modals/PatternSuggestionModal";
import DailyHabitsModal from "./modals/DailyHabitsModal";
import IncidentLoggingModal from "./modals/IncidentLoggingModal";
import IncidentFollowUpModal from "./modals/IncidentFollowUpModal";
import MedicationsLogTab from "../../pages/MedicalLog/MedicationsLogTab";
...
import { DashboardViewProvider } from "./shared/DashboardViewContext";
...
const DashboardPage = () => {
  ...
  const hook = useDashboard({ activeChildOnly: isMobile });
  ...
  useMountDebug('DashboardPage');
  trackRenderDebug('DashboardPage', {
    isMobile,
    isDesktop,
          ...
          >
            ...
            >
              ...
              <Box component="span" sx={{ display: 'block', fontWeight: 700 }}>
                Let&apos;s add a new person to track
              </Box>
            </Typography>
            <Button
              variant="contained"
