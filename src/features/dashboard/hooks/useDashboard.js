...
import { useDailyCareStatus } from "../../../hooks/useDailyCareStatus";
...
export const useDashboard = ({ activeChildOnly = false } = {}) => {
  ...
  const handleAddChildSuccess = (createdChild) => {
    ...
    if (childId) {
      ...
      if (typeof window !== 'undefined') {
        window.dispatchEvent(
          new CustomEvent('captureez:set-active-child', {
            detail: { childId },
          })
        );
      }
