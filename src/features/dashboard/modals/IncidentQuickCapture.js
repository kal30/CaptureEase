...
import DateTimeSection from "../../../components/Dashboard/Incidents/QuickCapture/DateTimeSection";
import SeveritySection from "../../../components/Dashboard/Incidents/QuickCapture/SeveritySection";
import RemedySection from "../../../components/Dashboard/Incidents/QuickCapture/RemedySection";
import IncidentMediaUpload from "../../../components/Dashboard/Incidents/Media/IncidentMediaUpload";
import FollowUpSection from "../../../components/Dashboard/Incidents/QuickCapture/FollowUpSection";
import ActionButtons from "../../../components/Dashboard/Incidents/QuickCapture/ActionButtons";
...
const IncidentQuickCapture = ({
  ...
  const handleSave = () => {
    incidentForm.submitForm(
      async () => {
        ...
        return await createIncidentWithSmartFollowUp(
          childId,
          incidentData,
          scheduleFollowUp,
          childName
  ...
  return (
    <Box
      sx={{ p: 4, backgroundColor: colors.app.cards.background, minHeight: "100%" }}
    >
      {incidentForm.error && (
        <Alert
          severity="error"
      ...
      <DateTimeSection value={incidentDateTime} onChange={setIncidentDateTime} />
