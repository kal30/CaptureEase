 ...
 * email.js
 *
 * Handles care team invitation emails:
 * - Generates HTML and text email templates
 * - Sends invitation emails via SendGrid
 * - Manages email tracking and configuration
 */

const { onCall } = require("firebase-functions/v2/https");
const sgMail = require("@sendgrid/mail");
const { logger, SENDGRID_API_KEY, FROM_EMAIL, SENDER_NAME } = require('./init');
